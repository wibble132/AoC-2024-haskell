...
-- main = do
--   !input <- getInput 14
--   let !parsedInput = Day14.readInput input
--   defaultMain
--     [ bgroup
--         "day 14"
--         [ bench "parse" $ whnf Day14.readInput input,
--           bench "Part 1" $ whnf Day14.part1 parsedInput,
--           bench "Part 2" $ whnf Day14.part2 parsedInput
--         ]
--     ]
