...
-- main = do
--   !input <- getInput 17
--   let !parsedInput = Day17.readInput input
--   defaultMain
--     [ bgroup
--         "day 17"
--         [ bench "parse 1" $ whnf Day17.readInput input,
--           bench "Part 1" $ whnf Day17.part1 parsedInput,
--           bench "Part 2" $ whnf Day17.part2 parsedInput
--         ]
--     ]
