...
-- main = do
--   !input <- getInput 21
--   let !parsedInput = Day21.readInput input
--   defaultMain
--     [ bgroup
--         "day 21"
--         [ bench "parse" $ whnf Day21.readInput input,
--           bench "Part 1" $ whnf Day21.part1 parsedInput,
--           bench "Part 2" $ whnf Day21.part2 parsedInput
--         ]
--     ]
