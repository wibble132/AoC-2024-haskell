...
main = do
  input <- getInput 12
  let !parsedInput = Day12.readInput input
  defaultMain
    [ bgroup
        "day 12"
        [ bench "parse" $ whnf Day12.readInput input,
          bench "Part 1" $ whnf Day12.part1 parsedInput,
          bench "Part 2" $ whnf Day12.part2 parsedInput
        ]
    ]
